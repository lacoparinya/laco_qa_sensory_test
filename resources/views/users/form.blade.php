{{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('laconame') ? ' has-error' : '' }}">
                            <label for="laconame" class="col-md-4 control-label">Laco Name</label>

                            <div class="col-md-6">
                                <input id="laconame" type="text" class="form-control" name="laconame" value="{{ old('laconame') }}"  autofocus>

                                @if ($errors->has('laconame'))
                                    <span class="help-block">
...
<div class="form-group {{ $errors->has('group_id') ? 'has-error' : ''}}">
    {!! Form::label('group_id', 'Group', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
