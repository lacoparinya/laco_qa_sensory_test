...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Sensorytests</div>
                    <div class="card-body">
                        <a href="{{ url('/sensory-tests/create') }}" class="btn btn-success btn-sm" title="Add New SensoryTest">
                            ...
                            <table class="table">
                                ...
                                @foreach($sensorytests as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/sensory-tests/' . $item->id) }}" title="View SensoryTest"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/sensory-tests/' . $item->id . '/edit') }}" title="Edit SensoryTest"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
