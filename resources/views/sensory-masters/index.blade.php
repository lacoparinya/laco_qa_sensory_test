...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Sensorymasters</div>
                    <div class="card-body">
                        <a href="{{ url('/sensory-masters/create') }}" class="btn btn-success btn-sm" title="Add New SensoryMaster">
                            ...
                            <table class="table">
                                ...
                                @foreach($sensorymasters as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/sensory-masters/' . $item->id) }}" title="View SensoryMaster"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/sensory-masters/' . $item->id . '/edit') }}" title="Edit SensoryMaster"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
