                        ...
                        <form method="POST" action="{{ url('/sensory/runtestAction/'.$sensorymaster->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <table class="table" >
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ Form::checkbox('chktested', $item->id, false,array('class' => 'chkall')) }} {{ $item->code }}<br/>{{ $item->qaSampleData->product_name }}</td>
                                        ...
                                        <td>Texture<div class=" {{ $errors->has('test['.$item->id.'][texture]') ? 'has-error' : ''}}">
                                        ...
                                        <td>Taste<div class=" {{ $errors->has('test['.$item->id.'][taste]') ? 'has-error' : ''}}">
